...
inputFile = strcat(data.paths.runDir, filesep, '20200120 - CostReductionScenarios_incCNaltSites.xlsx');

ExcelInputFile = Excel.Workbooks.Open(inputFile, 0, true); inputFileOpen = true;

outputFile = strcat(data.paths.runDir, filesep, '20200120 OWFC - Market and Site Data_incCNaltSites.xlsx');
