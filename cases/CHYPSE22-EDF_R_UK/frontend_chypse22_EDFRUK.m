...
marketFile = strcat(data.paths.runDir, filesep, 'CostReductionScenarios_CHypSE_2022_OWCAT_Nov22_flatprice_2030');
ExcelMarketFile = Excel.Workbooks.Open(marketFile, 0, true); MarketOpen = true;

siteFile = strcat(data.paths.runDir, filesep, '20221222-SNZ');
