...
%%-----------------------------------------------------------------------%%
o.OWF.loc      = 'UK';                  %wind farm geographical location %%
%%-----------------------------------------------------------------------%%
...
%%-----------------------------------------------------------------------%%
o.design.arrConf  = 'radial';           %inter-array cable configuration %%
...
o.finance.CuMult22  = 1;       %Cu price assumed same as 2020 for base case%%
%%-----------------------------------------------------------------------%%