...
CuMult20 = getCHypSEmarketData(ExcelFile, year, 'cumult20'); 
CuMult22 = getCHypSEmarketData(ExcelFile, year, 'cumult22');
...
projMods{end+1} = {'finance.CuMult20', CuMult20, '-'};
projMods{end+1} = {'finance.CuMult22', CuMult22, '-'};
