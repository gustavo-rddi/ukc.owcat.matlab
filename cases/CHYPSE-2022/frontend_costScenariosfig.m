...
inputFile = strcat(data.paths.runDir, filesep, 'CostReductionScenarios_CHypSE_2021_innov_20210202_eur_mid.xlsx');

ExcelInputFile = Excel.Workbooks.Open(inputFile, 0, true); inputFileOpen = true;

outputFile = strcat(data.paths.runDir, filesep, '20211020-eur_mid.xlsx');
