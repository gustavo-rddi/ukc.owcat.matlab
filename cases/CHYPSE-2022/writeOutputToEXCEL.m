...
ExcelSheet.Range([colCase, '45']).Value = o.OWF.lWake;
ExcelSheet.Range([colCase, '46']).Value = o.design.fSpace;
ExcelSheet.Range([colCase, '47']).Value = o.OWF.AEPnet / 3.6e12;
ExcelSheet.Range([colCase, '48']).Value = o.OWF.fCap;
ExcelSheet.Range([colCase, '49']).Value = o.LCOE.real.total * 3.6e9;
ExcelSheet.Range([colCase, '50']).Value = fMult;
