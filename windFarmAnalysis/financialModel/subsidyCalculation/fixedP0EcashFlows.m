function CF = fixedP0EcashFlows(o, data, P0R, stocVar, markMods)
...
CF.real.decContingency = ( CF.real.turbDecom + CF.real.fndDecom + CF.real.substationDecom ) * data.econ.contCon;                    

CF = calculateNominalCashFlows(o, CF, data);

[CF.nom.revTransmission, ~, ~] = subsidyRevenueStream(o, data, P0R, CF.t, 'P0R');
...
CF.nom.seabedRent = -calculateSeabedRent(o, 0, CF.t, data);      
