...
econ.contOp  = {6,'%'};              %operation contingency requirement %%
%%-----------------------------------------------------------------------%%
...
%%-----------------------------------------------------------------------%%
econ.UK.yrReal  = 2020;         %reference year for real cashflow values %%
econ.UK.yrPrice = 2020;        %reference year for subsidy/market prices %%
%%-----------------------------------------------------------------------%%
...
econ.UK.SBlease = {2,'%'};                       %seabed lease royalties %%
%%-----------------------------------------------------------------------%%
...
%%-----------------------------------------------------------------------%%
econ.FR.yrReal  = 2020;         %reference year for real cashflow values %%
econ.FR.yrPrice = 2020;        %reference year for subsidy/market prices %%
%%-----------------------------------------------------------------------%%
...
%%-----------------------------------------------------------------------%%
econ.FR.Pwhole  = {45.0,strcat(char(8364),'/MWh')};  %wholesale price (for reference year) %%
econ.FR.grWhole = {2,'%'};                %real wholesale price growth %%
econ.FR.OWtax   = {14148*1.075,strcat(char(8364),'/MW')};    %annual offshore wind tax (indexed) %%
%%-----------------------------------------------------------------------%%
